...
nohup accelerate launch examples/train_flux_structural_control_val.py \
--pretrained_model_name_or_path= \
--image_variation_model_path= \
--lora_model_path= \
--output_dir=${DATA_OUTPUT_DIR} \
--resolution=256 --width=128 --task="market" --train_batch_size=4 --val_batch_size=4 --num_train_epochs=20 --checkpointing_steps=1000 \
